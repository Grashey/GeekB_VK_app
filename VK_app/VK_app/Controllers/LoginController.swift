...
class LoginController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        let kittenAnimation = KittenAnimation()
        kittenAnimation.kittenMeowing(kittenHead: kittenHead, kittenPaws: kittenPaws, wordBallon: wordBallon, meowLabel: meowLabel)
